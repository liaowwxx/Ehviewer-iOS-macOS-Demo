...
### iOS设备：推荐使用AltStore 侧载

1. 在电脑上安装 [AltStore](https://altstore.io)（Windows/macOS），登录 AltServer，参考AltStore[官方文档](https://faq.altstore.io/)。
...
- 无需登录即可浏览公开内容（游客模式）。
- 支持三种登录方式：**用户名&密码**、**网页登录**、**Cookie 登录**。*（未测试）*
